...
namespace Qsor.Gameplay.osu.HitObjects
{
    public class HitCircle : HitObject
    {
        ...
        private void Load(TextureStore store)
        {
            ...
            _approachCircle.FadeOut();
            _approachCircle.Scale = new Vector2((float) BindableScale.Value * 2);
            
            BindableProgress.ValueChanged += val =>
            {
                _approachCircle.ScaleTo((float) (1 - BindableScale.Value * val.NewValue), 100);
            };
        }
        ...
        public override void Show()
        {
            ...
            Scheduler.AddDelayed(() => { _approachCircle.FadeIn(100); }, 300);
